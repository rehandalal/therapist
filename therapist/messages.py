...
EXISTING_HOOK_MSG = ('#{yellow}There is an existing pre-commit hook.\n'
                     '#{reset}Therapist can preserve this legacy hook and run it before the Therapist pre-commit hook.')
...
DONE_COPYING_HOOK_MSG = '#{green}#{bold}DONE'
...
DONE_INSTALLING_HOOK_MSG = '#{green}#{bold}DONE'
...
DONE_COPYING_LEGACY_HOOK_MSG = '#{green}#{bold}DONE'

REMOVING_LEGACY_HOOK_MSG = 'Removing `pre-commit.legacy`...\t'

DONE_REMOVING_LEGACY_HOOK_MSG = '#{green}#{bold}DONE'

UNINSTALLING_HOOK_MSG = 'Uninstalling pre-commit hook...\t'

DONE_UNINSTALLING_HOOK_MSG = '#{green}#{bold}DONE'
